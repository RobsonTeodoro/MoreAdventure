function carregar() {
  ...
  if (hora >= 0 && hora < 12) {
    //bom dia
    msg.innerHTML = `<rtrs style="color: green;"> <strong>Bom dia! São ${hora} hora(s) e ${minuto} minutos! </strong></rtrs> <br> Clique <a class="text-success" href="#enviar">aqui</a> e venha trilhar com a gente!`

    
  } else if (hora >= 12 && hora < 18) {
    //boa tarde
    msg.innerHTML = `<rtrs style="color: green;"> <strong>Boa tarde! São ${hora} hora(s) e ${minuto} minutos!</strong></rtrs> <br> Clique <a class="text-success" href="#enviar">aqui</a> e venha trilhar com a gente!`

    
  } else {
    //boa noite
    msg.innerHTML = `<rtrs style="color: green;"> <strong>Boa noite! São ${hora} hora(s) e ${minuto} minutos!</strong></rtrs> <br> Clique <a class="text-success" href="#enviar">aqui</a> e venha trilhar com a gente!`
